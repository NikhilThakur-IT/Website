...
function CardScheduler() {
  ...
  useEffect(() => {
    let ctx = gsap.context(() => {
      ...
      tl.to(cursorRef.current, {
        ...
        .to(
          targetDay,
          { backgroundColor: "#C9A84C", color: "#0D0D12", duration: 0.1 },
          "<",
        )
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full mt-6 bg-slate/30 border border-white/5 rounded-xl p-5 h-48 overflow-hidden select-none"
    >
      <p className="font-mono text-xs text-ivory/50 mb-3">
        Allocating AI curriculum...
      </p>
      ...
      <div
        ref={cursorRef}
        className="absolute top-0 left-0 w-6 h-6 z-20 pointer-events-none drop-shadow-xl text-ivory origin-top-left flex items-start justify-start"
      >
...
export default function Features() {
  ...
  return (
    <section
      id="features"
      ref={sectionRef}
      className="py-32 px-6 md:px-12 lg:px-24 bg-obsidian relative z-20 rounded-t-[3rem] -mt-8 shadow-[0_-20px_50px_rgba(0,0,0,0.5)]"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="feature-card bg-slate/20 rounded-[2rem] p-8 border border-white/5 shadow-lg relative overflow-hidden flex flex-col justify-between">
            <div className="relative z-10">
              <h3 className="text-xl font-inter font-bold text-ivory tracking-tight">
                Practical Career Development
              </h3>
              <p className="text-sm text-ivory/60 mt-3 leading-relaxed">
                Build a portfolio of AI projects, get mentorship, and land real
                opportunities.
              </p>
            </div>
            <CardShuffler />
          ...
          <div className="feature-card bg-slate/20 rounded-[2rem] p-8 border border-white/5 shadow-lg relative overflow-hidden flex flex-col justify-between">
            <div className="relative z-10">
              ...
              <p className="text-sm text-ivory/60 mt-3 leading-relaxed">
                Access hand-picked tutorials, courses, and workshops—no outdated
                material.
              </p>
            </div>
            <CardTypewriter />
          ...
          <div className="feature-card bg-slate/20 rounded-[2rem] p-8 border border-white/5 shadow-lg relative overflow-hidden flex flex-col justify-between">
            <div className="relative z-10">
              ...
              <p className="text-sm text-ivory/60 mt-3 leading-relaxed">
                Connect with like-minded learners, collaborate on projects, and
                grow together.
              </p>
            </div>
            <CardScheduler />
