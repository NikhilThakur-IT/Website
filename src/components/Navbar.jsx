  ...
  return (
    <nav className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-5xl">
      ...
      >
        ...
        <a
          href="#pricing"
          className="btn-magnetic bg-champagne text-obsidian px-5 py-2 rounded-full text-sm font-semibold tracking-wide hover:shadow-[0_0_20px_rgba(201,168,76,0.3)] transition-all"
        >
